...
# TODO clean this class up and document it properly
...
class Stats:
    ...
    def _refresh_stats(self, fast=False):
        ...
        if fast:
            ...
            self.stats["info"]["hostname"] = os.uname()[1]
            self.stats["info"]["architecture"] = self._get_platform_var(
            ...
            self.stats["info"]["python_build"] = self._get_platform_var(
